...
parser.add_argument('--model', default='slfn', type=str, help='model',
                        choices=['slfn', 'tlfn'])
parser.add_argument('--optimizer', default='sgld', type=str, help='optimizer', choices=['sgld', 'adam', 'amsgrad', 'rmsprop', 'tusla', 'sghmc'])
...
def get_ckpt_name(dataset='f_mnist', seed=111, model='resnet', optimizer='sgld', lr=0.1, momentum=0.9,
...
optimizer = { 'sgld': SGLD(net.parameters(), lr=args.lr, weight_decay=args.weight_decay),
